...
<html>
	...
	<div class="main">
			...
			<div class="temp_cont">
				...
				<div class="temp" style="border:2px solid red;"> <a href="time_table.php"><img src="image/time_table.jpg" height="100%" width="100%"/></a></div>
			...
			<div class="right_panel">
				<div class="item">
					...
					<!--<img src="image/<?php echo $login_user_sem?>.jpg" alt="<?php echo $login_user_sem?>" height="100%" width="100%"/>?-->
				</div>
			</div>
	</div>
	</body>
