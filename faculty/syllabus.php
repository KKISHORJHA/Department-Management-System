...
<html>
	...
	<div class="main">
						...
						<?php
							if(empty($login_user_image))
							  ...
							  else
							  {
								$enc= new Encryption;
								$encdata=$enc->safe_b64encode($login_session );
								echo '<img src="data:image/jpeg;base64,'.base64_encode($login_user_image).'" height="100%" width="100%" style=""/></img>';
							 } 
						?>
					</div>
			...
			<div class="temp_cont">
				...
				<div class="temp" style="border:2px solid red;"><a href="syllabus.php"><img src="image/syllabus.jpg" height="100%" width="100%"/></a></div>
			...
			<div class="right_panel">
				<div class="item">
					...
					<a href="mca.pdf" style="padding:20px; color:black;" target="_blank">MCA 2018-2021</a>
					<?php
